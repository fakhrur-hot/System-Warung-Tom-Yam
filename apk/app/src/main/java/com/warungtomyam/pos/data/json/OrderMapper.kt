 ...
 * ([com.warungtomyam.pos.data.ApiClient]), the admin Realtime `NEW_ORDER`
 * broadcast ([com.warungtomyam.pos.realtime.RealtimeService]), and the ordering
 * foreground service ([com.warungtomyam.pos.realtime.OrderingForegroundService]).
