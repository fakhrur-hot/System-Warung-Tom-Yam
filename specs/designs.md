...
│         (+ optional translations: EN / 中文 / தமிழ் — no images;
...
| Entity | Key Fields |
|---|---|
| `MenuItem` | id, nameBM, nameEN, nameZH, nameTM, descBM, descEN, descZH, descTM, price, category (FOOD\|BEVERAGES\|SIDE_DISHES\|OTHERS), askMeDaily, isAvailable, lastAvailabilityConfirmedDate |
...
| 9 | Missing translations for Mandarin/Tamil on menu items | Medium | Add a "Translations" sub-screen in menu item edit; highlight untranslated items with a warning badge |
...
| A | Dictionary-translation i18n (English base → BM/ZH/TA) is unproven | Medium | Tracked as REQ-12 Gap A — research static-string dictionaries, curated food-term dictionary, English fallback, offline/zero-cost constraint |
