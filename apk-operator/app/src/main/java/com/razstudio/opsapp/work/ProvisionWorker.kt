package com.razstudio.opsapp.work
 ...
 *
 * Ported verbatim from `apk/app`'s `com.razstudio.pos.work.ProvisionWorker` (bugfix/design.md
 * Requirement 8). Provisioning can take several minutes (Supabase project creation + 33 Edge
 * Function deploys), so doing it on a ViewModel coroutine would be lost on configuration change or
 * screen-off. WorkManager keeps it alive under the normal OS constraints.
 */
