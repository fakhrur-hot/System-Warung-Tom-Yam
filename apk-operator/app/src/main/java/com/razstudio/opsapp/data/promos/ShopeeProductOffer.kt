 ...
 *
 * Ported from `apk/app`'s `com.razstudio.pos.data.promos.ShopeeProductOffer` (bugfix/design.md
 * Requirement 8) — represents a single product listing as returned by Shopee's GraphQL endpoint,
